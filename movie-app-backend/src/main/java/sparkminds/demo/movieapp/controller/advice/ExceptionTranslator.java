package sparkminds.demo.movieapp.controller.advice;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEntityNotFound(NotFoundException exception, NativeWebRequest request) {
